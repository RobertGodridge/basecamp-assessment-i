...
if (notHakeem !== 'Hakeem Olajuwon') {
  if (notHakeem === 'Karl Malone') {
    console.log('You are Karl Malone')
  }
  else console.log(`You are neither Karl Malone or Hakeem Olajuwon and your name is ${notHakeem}`)
}
